...
export const CHANGELOG:{
  ...
  changes:[
    ...
    "TODO: Fix window wrapper on home page",
    "TODO: Add more games",
    ...
    "Added LOTS of games x3",
    "Attempted many homepage fixes",
    "Implemented old selector from XP era",
    "Started beanforged implementation",
