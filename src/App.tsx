...
export const CHANGELOG:{
  ...
  comment: "tweaky time//checkpoint",
  changes:[
    "TODO: Add more themes",
    "TODO: Move more stylistic code to theme file",
    "TODO: Work on clock dialog",
    "Added taskbar reorginization",
    "Added window symbol enums",
    "Added dialog component (simple)",
    "Added more taskbar tweaks",
    "Reorganized and cleaned code",
