...
const tips:string[]=[
    ...
    "Correction: we use Vite/React/Jotai/Motion/Sass/BaseUI",
    ...
    "i need to read the game request link lowk",
    ...
    "finally learnt typescript, as a correction to my old shi",
    "90210",
    "commit & sync",
    "'ExpressDerivedWinModifierAtom' (yes that's actually in the source 😭)",
    "tweaky time",
    "finally learned how to write commit messages",
    "kill me",
    "save me",
    "yarn<<pnpm icl",
    "there aren't any actual tips in here anyway"
];
export default tips;